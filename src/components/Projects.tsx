...
import { ExternalLink, Github, BarChart3, PlayCircle, Database } from 'lucide-react';
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex space-x-4">
                    <button className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 animate-glow">
                      <ExternalLink className="h-4 w-4" />
                      <span>View Project</span>
                    </button>
                    <button className="flex items-center space-x-2 px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 hover:scale-105 transition-all duration-300 hover:border-blue-400 dark:hover:border-blue-500">
